                            ...
                            <asp:Repeater ID="rptCostList" runat="server">
                                <ItemTemplate>
                                    <li>
                                        ...
                                        <div class="btns">
                                            数量：<input type="text" name="CostCount" onkeydown="return checkForFloat(this,event);" value="<%#Eval("Count") %>" style="width: 50%;" />
                                        </div>
                                        <div class="btns">
                            ...
                            <asp:Repeater ID="rptGoodsList" runat="server">
                                <ItemTemplate>
                                    <li>
                                        ...
                                        <div class="btns">
                                            数量：<input type="text" name="Count" value="<%#Eval("Count") %>" style="width: 50%;" />
                                        </div>
                                        <div class="btns">
