<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="storein_cost_edit.aspx.cs" Inherits="DTcms.Web.admin.business.storein_cost_edit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content" style="min-height: 800px;">
            <dl>
                <dt>入库单</dt>
                <dd>
                    <asp:Label ID="labAccountNumber" runat="server" Text=""></asp:Label>
                </dd>
            </dl>
            <dl>
                <dt>客户名称</dt>
