<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="check_cost_edit.aspx.cs" Inherits="DTcms.Web.admin.business.check_cost_edit" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="check_cost_list.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="check_cost_list.aspx"><span>查验费用管理</span></a>
            <i class="arrow"></i>
            <span>编辑查验费用</span>
        </div>
