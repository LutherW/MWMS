...
{
    public partial class store_out_order : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _goodsby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("store_out_order.aspx", "customer_id={0}&keyword={1}&beginTime={2}&endTime={3}&page={4}",
        ...
        {
            ChkAdminLevel("store_out_order", DTEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.StoreOutOrder bll = new BLL.StoreOutOrder();
