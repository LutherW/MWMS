...
{
    public partial class dialog_storeout_goods : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.storeOutOrderId = DTRequest.GetQueryInt("orderId");
            ...
            if (!Page.IsPostBack)
            {
                ...
                TreeBind("");
                RptBind(" and A.StoreOutOrderId = " + storeOutOrderId + " " + CombSqlTxt(this.customer_id, this.goods_id, this.beginTime, this.endTime), "A.Id ASC");
            }
        }
        ...
        private void RptBind(string _strWhere, string _goodsby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("dialog_storeout_goods.aspx", "customer_id={0}&goods_id={1}&beginTime={2}&endTime={3}&page={4}",
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("store_out_page_size", "DTcmsPage"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        //{
        //    Response.Redirect(Utils.CombUrlTxt("dialog_storeout_goods.aspx", "customer_id={0}&goods_id={1}&beginTime={2}&endTime={3}",
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("store_out_page_size", "DTcmsPage", _pagesize.ToString(), 14400);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("dialog_storeout_goods.aspx", "customer_id={0}&goods_id={1}&beginTime={2}&endTime={3}",
