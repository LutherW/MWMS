...
namespace Maticsoft.BLL .DTcms.BLL{
		...
		public partial class StoreOutOrder
	{
		...
		private readonly Maticsoft.DAL.StoreOutOrder dal=new Maticsoft.DAL.StoreOutOrder();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.StoreOutOrder GetModelByCache(int Id,int CustomerId,int StoreInUnitPriceStoreInOrderId)
		{
			...
			return (Maticsoft.Model.StoreOutOrder)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.StoreOutOrder> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.StoreOutOrder> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.StoreOutOrder> modelList = new List<Maticsoft.Model.StoreOutOrder>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.StoreOutOrder model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Maticsoft.Model.StoreOutOrder();					
