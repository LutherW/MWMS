...
namespace Maticsoft.BLL .DTcms.BLL{
		...
		public partial class Store
	{
		...
		private readonly Maticsoft.DAL.Store dal=new Maticsoft.DAL.Store();
		public Store()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.Store GetModelByCache(int Id,int StoreDomainId)
		{
			...
			return (Maticsoft.Model.Store)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Store> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Store> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.Store> modelList = new List<Maticsoft.Model.Store>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Store model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Maticsoft.Model.Store();					
