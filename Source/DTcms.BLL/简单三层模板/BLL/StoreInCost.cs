...
namespace Maticsoft.BLL .DTcms.BLL{
		...
		public partial class StoreInCost
	{
		...
		private readonly Maticsoft.DAL.StoreInCost dal=new Maticsoft.DAL.StoreInCost();
		public StoreInCost()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.StoreInCost GetModelByCache(int StoreInOrderId)
		{
			...
			return (Maticsoft.Model.StoreInCost)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.StoreInCost> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.StoreInCost> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.StoreInCost> modelList = new List<Maticsoft.Model.StoreInCost>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.StoreInCost model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Maticsoft.Model.StoreInCost();					
