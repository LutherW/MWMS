	...
	.DTcms.DAL
{
		...
		public partial class StoreDomain
	{
		...
		/// 增加一条数据
		/// </summary>
		public void Add(Maticsoft.Model.StoreDomain model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.StoreDomain model)
		{
			StringBuilder strSql=new StringBuilder();
...
SqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.StoreDomain GetModel(int Id)
		{
			...
			Maticsoft.Model.StoreDomain model=new Maticsoft.Model.StoreDomain();
