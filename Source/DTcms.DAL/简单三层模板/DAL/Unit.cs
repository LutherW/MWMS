	...
	.DTcms.DAL
{
		...
		public partial class Unit
	{
		...
		/// 增加一条数据
		/// </summary>
		public void Add(Maticsoft.Model.Unit model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.Unit model)
		{
			StringBuilder strSql=new StringBuilder();
...
SqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Unit GetModel(int Id)
		{
			...
			Maticsoft.Model.Unit model=new Maticsoft.Model.Unit();
