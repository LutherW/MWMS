	...
	.DTcms.DAL
{
		...
		public partial class StoreOutCost
	{
		...
		public void Add(Maticsoft.Model.StoreOutCost model)
		{
            ...
            strSql.Append("SQL2012StoreOutOrderId,SQL2012Name,SQL2012Count,SQL2012UnitPrice,SQL2012TotalPrice,SQL2012Status,SQL2012PaidTime,SQL2012Admin,SQL2012Customer,SQL2012HasBeenInvoiced,SQL2012InvoicedTime,SQL2012InvoicedOperator,SQL2012Remark");            
            strSql.Append(") ");            
...
SqlParameter[] parameters = {
		...
		public Maticsoft.Model.StoreOutCost GetModel(int StoreOutOrderId)
		{
			...
			Maticsoft.Model.StoreOutCost model=new Maticsoft.Model.StoreOutCost();
