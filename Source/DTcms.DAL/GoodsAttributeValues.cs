...
SqlParameter[] parameters = {
        ...
        public void DeleteList(SqlConnection conn, SqlTransaction trans, int goodsId)
        {
            int rows = DbHelperSQL.ExecuteSql(conn, trans, "delete from GoodsAttributeValues where GoodsId=" + goodsId.ToString()); 
        }		
